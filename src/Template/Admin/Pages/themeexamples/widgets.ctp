...
<?php // Body scripts
    $this->Html->script(
    [
        'KingLoui/BaseKit.vendor/jqueryui/jquery-ui.min.js', 
        'KingLoui/BaseKit.vendor/iCheck/icheck.min.js', 
        'KingLoui/BaseKit.vendor/jvectormap/jquery-jvectormap-2.0.3.min.js', 
        'KingLoui/BaseKit.vendor/jvectormap/jquery-jvectormap-world-mill-en.js', 
        'KingLoui/BaseKit.vendor/flot/jquery.flot.js', 
        'KingLoui/BaseKit.vendor/flot/jquery.flot.tooltip.min.js', 
        'KingLoui/BaseKit.vendor/flot/jquery.flot.resize.js', 
    ], 
    ...
    <div class="row">
        <div class="col-lg-4">
                <div class="widget-head-color-box navy-bg p-lg text-center">
                    ...
                    <?= $this->Html->image('KingLoui/BaseKit.theme-basekit-admin/themeexamples/a4.jpg', 
        ...
        <div class="chat-activity-list">
            ...
            <div class="chat-element">
                <a href="#" class="pull-left">
                    <?= $this->Html->image('KingLoui/BaseKit.theme-basekit-admin/themeexamples/a2.jpg', 
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="ibox-content text-center">
                        <h1>Nicki Smith</h1>
                        <div class="m-b-sm">
                            <?= $this->Html->image('KingLoui/BaseKit.theme-basekit-admin/themeexamples/a8.jpg', 
                    ['class' => 'img-circle', 'alt' => 'image']) ?>
